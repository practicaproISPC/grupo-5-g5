...
<body>
	...
	<br> <p> El objetivo de la web es el de ofrecer contenido, entretenimiento y servicios relacionados con las Finanzas Personales. <p>
        ...
        <p> Desde <b id="npro"></b> se toman medidas activas y pasivas referentes a la seguridad de nuestra web, pero no se puede garantizar la inexistencia de malware u otros elementos que puedan producir alteraciones en los sistemas informáticos del usuario. Si detectas cualquier comportamiento irregular en el buen funcionamiento de la web, puedes contactar con nosotros a través del formulario de contacto. </p>
        <p> Los contenidos y servicios ofrecidos en la web son gratuitos </p>
        <h2> Derechos propiedad intelectual <b id="np2"></b>  </h2>
        <p> <b id="np3"></b> es titular de todos los derechos de autor, propiedad intelectual, industrial, “know how” y cuantos otros derechos guardan relación con los contenidos del sitio web y de los servicios ofertados en el mismo, así como de los programas necesarios para su implementación y la información relacionada. No se permite la reproducción, transformación, publicación y/o uso no estrictamente privado de los contenidos, totales o parciales, en medios digitales, impresos u otros, del sitio web sin el consentimiento previo y por escrito. </p>
        <h2> Propiedad intelectual del software </h2>
        <p> El usuario debe respetar los programas de terceros puestos a su disposición por <b id="np19"></b>, aun siendo gratuitos y/o de disposición pública. <p>
        <p> <b id="np4"></b> dispone de los derechos de explotación y propiedad intelectual necesarios del software. </p>
        <p> El usuario no adquiere derecho alguno o licencia por el servicio contratado, sobre el software necesario para la prestación del servicio, ni tampoco sobre la información técnica de seguimiento del servicio, excepción hecha de los derechos y licencias necesarios para el cumplimiento de los servicios contratados y únicamente durante la duración de los mismos. Para toda actuación que exceda del cumplimiento del contrato, el usuario necesitará autorización por escrito por parte de <b id="np16"></b>, quedando prohibido al usuario acceder, modificar, visualizar la configuración, estructura y ficheros de los servidores propiedad de <b id="np15"></b>, asumiendo la responsabilidad civil y penal derivada de cualquier incidencia que se pudiera producir en los servidores y sistemas de seguridad como consecuencia directa de una actuación negligente o maliciosa por su parte. </p>
        <h2> Propiedad intelectual de los contenidos alojados </h2>
        <p> Se prohíbe el uso contrario a la legislación sobre propiedad intelectual de los servicios prestados por <b id="np18"></b> y en particular de: </p>
        <li type="square"> La utilización que resulte contraria a las leyes o que infrinja los derechos de terceros.</li>
        <li type="square"> La publicación o la transmisión de cualquier contenido que, a juicio de <b id="np20"></b>, resulte violento, obsceno, abusivo, ilegal, racial, xenófobo o difamatorio. </li>
        ...
        <p> El usuario tiene toda la responsabilidad sobre sus propios contenidos, la información transmitida y almacenada, los enlaces de hipertexto, las reivindicaciones de terceros y las acciones legales en referencia a propiedad intelectual, derechos de terceros y protección de menores. El usuario es responsable respecto a las leyes y reglamentos en vigor y las reglas que tienen que ver con el funcionamiento del servicio online, comercio electrónico, derechos de autor, mantenimiento del orden público, así como principios universales de uso de Internet. El usuario indemnizará a <b id="np11"></b> por los gastos que generara la imputación de <b id="np12"></b> en alguna causa cuya responsabilidad fuera atribuible al usuario, incluidos honorarios y gastos de defensa jurídica, incluso en el caso de una decisión judicial no definitiva. </p>
        <p> En las páginas de <b id="np5"></b> encontrarás enlaces a sitios web de terceros con el único objeto de completar información, compartir contenido relevante, o en el caso de enlaces de afiliados, proponer productos o servicios que puedan ser de interés. A pesar de que se toman las medidas oportunas para asegurarse de que los contenidos enlazados ofrecen garantías, <b id="np10"></b> no se responsabiliza de los resultados que puedan derivarse por el acceso a dichos enlaces ni del contenido de dichas páginas. </p>
        <p> En <b id="np6"></b> se publican artículos, cursos y contenidos diversos, cuya autoría proviene de personas ajenas a nuestra web. Pedimos a todos estos colaboradores que respeten las leyes del copyright y los derechos de autor en todo aquello que se publica desde nuestras páginas. Si esto no se cumple, no nos hacemos responsables de ello, por estar fuera de nuestro conocimiento. </p>
        <p> Si en cualquier caso se observa alguna circunstancia que atente contra las leyes del copyright o los derechos de autor, ésta deberá ser comunicada lo antes posible a <b id="np9"></b> a través del formulario de contacto, para poder subsanar el error o retirar el material si es necesario. </p>
        <p> No podemos garantizar la completa veracidad, fiabilidad y/o exactitud de todos los contenidos de la web, especialmente los provenientes de autores ajenos a <b id="np8"></b> y los de las secciones con participación de los usuarios como los foros. </p>
        ...
        <p> <b id="np7"></b> no otorga ninguna garantía ni se hace responsable en ningún caso de los daños y perjuicios que pudieran derivar de: </p>
        ...
        <p> Nos esforzamos por mantener la página segura y libre de software malicioso. Si detectas cualquier comportamiento o actividad extraña en nuestra web, puedes comunicárnoslo a la dirección  <a href="mailto:ejemplo@gmail.com"> nuestro@ejemplo.com </a> </p>
        <p> También queda a su disposición mayor información: <a href="https://bildenlex.com/propiedad-intelectual/cuales-textos-legales-debe-tener-una-pagina-web-2/" target="_blank">Legales</a> </p>
