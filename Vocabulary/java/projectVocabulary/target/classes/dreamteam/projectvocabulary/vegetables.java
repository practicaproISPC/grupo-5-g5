...
public class vegetables extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet vegetables</title>");            
            out.println("</head>");
            out.println("<body>");
            System.out.println("<h1>Servlet vegetables at " + request.getContextPath() + "</h1>");
            out.println("<main>");
            out.println("<p> {\"vegetables\":[<br/>");
            try {

                out.println(this.getVegetables());
    ...
    public static String getVegetables() throws SQLException{
        ...
        String sql = "SELECT w.word, w.url\n"
                ...
                + "					WHERE wc.description = \"vegetables\";";
