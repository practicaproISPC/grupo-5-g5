...
public class bedroom extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet bedroom</title>");            
            out.println("</head>");
            out.println("<body>");
            System.out.println("<h1>Servlet bedroom at " + request.getContextPath() + "</h1>");
            out.println("<main>");
            out.println("<p> {\"bedroom\":[<br/>");
            try {

                out.println(this.getBedroom());
    ...
    public static String getBedroom() throws SQLException{
