...
public class frutis extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet frutis</title>");            
            out.println("</head>");
            out.println("<body>");
            System.out.println("<h1>Servlet frutis at " + request.getContextPath() + "</h1>");
            out.println("<main>");
            out.println("<p> {\"frutis\":[<br/>");
            try {
                out.println(this.getFrutis());
    ...
    public static String getFrutis() throws SQLException{
