...
<body>
			...
			<div class="container">
				<div class="row text-center">
					<div class="col-md-8">
						...
						<h2 class="white-text"><u>Registrar</u>: la clave de la buena administración financiera </h2>
	...
	<br> <p class="resaltado"> <strong> Te esperamos el próximos mes para poder hacerte una  evaluación personalizada y completamente gratis. 
		<br> Muchos éxitos y manos a la obra.</strong> </p>
