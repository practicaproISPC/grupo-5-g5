...
<body>
    ...
    tratamiento que se hace de los datos personales de los usuarios atendiendo 
    a la legislación vigente en materia de protección de datos. 
    En esta página encontrarás toda la información sobre la recopilación y 
    el uso de datos que realizamos.<p>

    <p> Utilizamos un compendio de buenas prácticas, transparencia y
    tratamiento responsable en el uso que hacemos de los 
    datos personales recogidos a través de los formularios de nuestra web,
    y en los datos de navegación anónimos que obtenemos a través de 
    servicios de terceros. También tomamos las medidas de seguridad 
    ...
    y acepta las restricciones de uso que se puedan imponer en cada caso.<p> 
        
<h2> Finalidad de los datos obtenidos <h2> 
