...
<html lang="en">
	<head>
		...
		<title>Test de Finanzas Personales - Política de cookies</title>
...
print "   
        ...
        <p> Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas 
            ...
            almacenar o acceder a información en un dispositivo, anuncios y contenido personalizados, medición
            de anuncios y del contenido, información sobre el público y desarrollo de servicios, compartir tus
            análisis de navegación y grupos de interés con terceros, enriquecimiento con datos de terceros,
            datos de localización geográfica precisa e identificación mediante las características de dispositivos.</p>
        ...
        <h2>¿Como gestionar las cookies?</h2>
            ...
            sin que afecte al funcionamiento del sitio web; sin embargo, la información captada por estas 
            cookies sobre el uso de nuestra web y sobre el éxito de los anuncios mostrados en ella permite 
            mejorar nuestros servicios y obtener ingresos que nos permiten ofrecerle de forma gratuita 
            muchos contenidos.<br></p>
            <p>Como usuario podrás elegir qué cookies quieres que funcionen en este sitio web mediante:</p>
            ...
            <p>Asimismo, como usuario puede activar:</p>
                <ul>
                    <li>La navegación privada, mediante la cual su navegador deja de guardar el historial 
                        de navegación, contraseñas de sitios web, cookies y otra información de las páginas 
                        que visita; o</li>
